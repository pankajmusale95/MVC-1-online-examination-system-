...
<tr>
<td><c:out value="${table.stu_id}"/></td>
...
<td><a href="updatestudent.html"><button type="button">Update</button></a></td>
<td><a href="deletestudent.html"><button type="button">Delete</button></a></td>
</tr>
</c:forEach>
</tbody>
</table>

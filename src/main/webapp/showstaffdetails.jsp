...
<tr>
<td><c:out value="${table.sta_id}"/></td>
...
<td><a href="updatastaff.html"><button type="button">Update</button></a></td>
<td><a href="deletestaff.html"><button type="button">Delete</button></a></td>
</tr>
</c:forEach>
</tbody>
</table>

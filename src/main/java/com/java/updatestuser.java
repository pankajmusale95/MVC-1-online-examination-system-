...
@WebServlet("/updatestuser")
public class updatestuser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement(
					"update admin_student set fname=?,lname=?,email=?,address=?,dob=?,mobile_no=?,gender=? where stu_id=?");
